...
class CYSeekViewController: CYSBaseViewController,CYCustomSegmentedViewDelegate {
...
extension CYSeekViewController : UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if let seekPostCell = cell as? CYSeekPostCell{
            ...
            seekPostCell.typeLabel.text = "商业"
            seekPostCell.titleLable.text = "撒打算打算打算打算打算的"
            seekPostCell.contentLabel.text = "撒打算几点回家卡圣诞节喀什的空间啊是贷款计划"
        ...
        if let seekUserCell = cell as? CYSeekUserCell{
            ...
            seekUserCell.nameLabel.text = "小白"
            seekUserCell.pContentLabel.text = "撒打算几点回家卡圣诞节喀什的空间啊是贷款计划"
            seekUserCell.rContentLabel.text = "撒打算几点回家卡圣诞节喀什的空间啊是贷款计划"
        }
        return cell
    }
